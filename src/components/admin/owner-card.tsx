    ...
    <Card>
        ...
        {owner ? (
          <div className="space-y-2">
            ...
            <p>
              ...
              <a href={owner.github_url} className="text-primary hover:underline">
                {owner.github_url}
              </a>
            </p>
          </div>
      ...
      <CardFooter>
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Edit Portfolio Owner</DialogTitle>
            </DialogHeader>
            <form ref={formRef} action={handleAction} className="space-y-4">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  name="linkedin_url"
                  type="url"
                  defaultValue={owner?.linkedin_url}
                  required
                />
              </div>
              <div className="grid gap-2">
