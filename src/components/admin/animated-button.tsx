    ...
    <button className="button" type="button">
      ...
      <div className="wrap">
        ...
        <div className="content">
          <span className="char state-1" style={{ color: '#FFFFFF' }}>
             <span data-label="S" style={{'--i': 1} as React.CSSProperties}>S</span>
             <span data-label="h" style={{'--i': 2} as React.CSSProperties}>h</span>
             ...
             <span data-label="u" style={{'--i': 13} as React.CSSProperties}>u</span>
             <span data-label="e" style={{'--i': 14} as React.CSSProperties}>e</span>
          </span>
        </div>
      </div>
    </button>
